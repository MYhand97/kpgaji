...
<body>
    ...
    <main role="main">
        ...
        <div class="form-inline d-flex justify-content-center md-form form-sm mt-0">
            ...
            <a class="btn btn-success ml-3" href="data_karyawan/tambah_karyawan.php" role="button">Tambah Data</a>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tbody id="myTable">
                    ...
                    while($row = mysqli_fetch_array($query)){
                        ...
                        echo '<td>
                        <a class="btn btn-warning btn-sm" href="data_karyawan/edit_karyawan.php?id='.$row['id'].'" role="button">Ubah</a>
                        <a class="btn btn-danger btn-sm" href="data_karyawan/hapus_karyawan.php?id='.$row['id'].'" role="button" onclick="return confirm(\'yakin ingin menghapus data ini?\')">Hapus</a>
                        </td>';
                        $no++;
                    }
                    ?>
