    ...
    <main role="main">
        ...
        <div class="container">
            <div class="card card-signin">
                <div class="card-body">
                    <h5 class="card-title text-center">Edit Data Gajian</h5>
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $tgl = date("Y-m-d");
                        $query=mysqli_query($conn, "update tbgaji set periode='$periode', nik='$nik', nama='$nama', 
                        jabatan='$jbtan', bagian='$bgian', jmlmasuk='$jmlmasuk', gajipokok='$gpokok', jmllembur='$lembur', 
                        uanglembur='$uanglembur', bpjstk='$bpjstk', bpjspen='$bpjspen', bpjskes='$bpjskes', 
                        pph='$pph', pinjaman='$pinjaman', tglup='$tgl' where id='$id'") or die(mysqli_error($conn));
                        if($query){
                    ...
                    <br>
                    <form class="form-signin" action="edit_gaji.php?id=<?php echo $id; ?>" method="POST">
                        <div class="form-label-group">
                            <input type="text" id="periode" name="periode" class="form-control" placeholder="Periode" value="<?php echo $data['periode']; ?>" required autofocus>
                        </div>
                        <br>
                        
                        <div class="form-label-group">
                            <input type="text" id="nik" name="nik" class="form-control" placeholder="N I K" value="<?php echo $data['nik']; ?>" required>
                        </div>
                        <br>
                        ...
                        <div class="form-label-group">
                            <input type="text" id="jmlmasuk" name="jmlmasuk" class="form-control" placeholder="Jumlah Masuk (Hari)" value="<?php echo $data['jmlmasuk']; ?>" required>
                        </div>
                        <br>

                        <div class="form-label-group">
                            <input type="text" id="jmllembur" name="jmllembur" class="form-control" placeholder="Jumlah Lembur (Jam)" value="<?php echo $data['jmllembur']; ?>">
                        </div>
                        <br>

                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="bpjstk" name="bpjstk" <?php if($data['bpjstk'] != 0) { echo 'checked'; } ?>>
                            <label class="form-check-label" for="bpjstk">BPJS Tenaga Kerja</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="bpjspen" name="bpjspen" <?php if($data['bpjspen'] != 0) { echo 'checked'; } ?>>
                            <label class="form-check-label" for="bpjspen">BPJS Jaminan Pensiun</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="bpjskes" name="bpjskes" <?php if($data['bpjskes'] != 0) { echo 'checked'; } ?>>
