            ...
            <div class="card card-signin">
                <div class="card-body">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if(in_array($file_ext, $allowed_ext) === true){
                            if($file_size < 10485760){
                                ...
                                $query = mysqli_query($conn, "insert into fileabsen(id,tglupload,nfile,tipefille,ukfile,file)
                                values (NULL, '$tgl', '$nama', '$file_ext', '$file_size','$lokasi')") or die(mysqli_error($conn));
                                if($query){
                                    echo '<script>alert("Berhasil mengupload file."); document.location="../absen_karyawan.php";</script>';
                                }
                                else{
                    ...
                    <form class="form-signin" action="upload_file.php" method="POST" enctype="multipart/form-data">
                        ...
                        <a class="btn btn-danger btn-block" href="../absen_karyawan.php" role="button"> Kembali </a>
