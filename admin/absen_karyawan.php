...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">    
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="absen_karyawan.php">Absen Karyawan</a>
                </li>
                <li class="nav-item">
    ...
    <main role="main">
        ...
        <div class="jumbotron">
            <div class="container">
                <br><br>
                <h1 class="display-3">Absen Karyawan</h1>
            </div>
        </div>
        ...
        <div class="form-inline d-flex justify-content-center md-form form-sm mt-0">
            ...
            <a class="btn btn-success ml-3" href="absen_karyawan/upload_file.php" role="button">Upload File</a>
        </div>
        ...
        <div class="container-fluid table-responsive-xl">
            ...
            <table class="table table-hover">
                ...
                <tbody id="myTable">
                    <?php
                    $query = mysqli_query($conn, "select * from fileabsen order by nfile asc");
                    if(mysqli_num_rows($query) > 0){
                        ...
                        while($row = mysqli_fetch_array($query)){
                            ...
                            echo '<td>'.$row['tipefille'].'</td>';
                            echo '<td>'.formatSizeUnits($row['ukfile']).'</td>';
                            echo '<td>
                            <a class="btn btn-success btn-sm" href="absen_karyawan/'.$row['file'].'" role="button">Download</a>
                            <a class="btn btn-danger btn-sm" href="absen_karyawan/delete_file.php?id='.$row['id'].'&file='.$row['file'].'" role="button" onclick="return confirm(\'yakin ingin menghapus file ini?\')">Hapus</a>
