            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item active" href="../laporan/laporan_karyawan.php">Laporan Data Karyawan</a>
        ...
        <div class="container">
            <div class="card card-signin">
                <div class="card-body">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if(in_array($file_ext, $allowed_ext) === true){
                            if($file_size < 10485760){
                                $lokasi = 'fileskaryawan/'.$nama.'.'.$file_ext;
                                move_uploaded_file($file_tmp, $lokasi);
                                $query = mysqli_query($conn, "insert into filekaryawan(id,tglupload,nfile,tipefile,ukfile,file)
                                values (NULL, '$tgl', '$nama', '$file_ext', '$file_size','$lokasi')") or die(mysqli_error($conn));
                                if($query){
                                    echo '<script>alert("Berhasil mengupload file."); document.location="laporan_karyawan.php";</script>';
                                }
                                else{
                    ...
                    <br>
                    <form class="form-signin" action="upload_laporan_karyawan.php" method="POST" enctype="multipart/form-data">
                        ...
                        <a class="btn btn-danger btn-block" href="laporan_karyawan.php" role="button"> Kembali </a>
