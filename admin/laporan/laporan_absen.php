...
<body>
    ...
    <main role="main">
        ...
        <div class="form-inline d-flex justify-content-center md-form form-sm mt-0">
            ...
            <a class="btn btn-success ml-3" href="upload_laporan_absen.php" role="button">Upload</a>
        </div>
        ...
        <div class="container-fluid table-responsive-xl">
            ...
            <table class="table table-hover">
                ...
                <tbody id="myTable">
                    <?php
                    $query = mysqli_query($conn, "select * from laporanabsen order by nfile asc");
                    if(mysqli_num_rows($query) > 0){
                        ...
                        while($row = mysqli_fetch_array($query)){
                            ...
                            <a class="btn btn-danger btn-sm" href="hapus_laporan_absen.php?id='.$row['id'].'&file='.$row['file'].'" role="button" onclick="return confirm(\'yakin ingin menghapus file ini?\')">Hapus</a>
                            </td>';
                            $no++;
                        }
                    }
