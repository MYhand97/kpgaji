...
<body>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="laporan_karyawan.php">Laporan Data Karyawan</a>
                        <a class="dropdown-item" href="laporan_absen.php">Laporan Absen Karyawan</a>
                        <a class="dropdown-item active" href="laporan_gaji.php">Laporan Gaji Karyawan</a>
                    </div>
                </li>
            </ul>
    ...
    <main role="main">
        ...
        <div class="jumbotron">
            <div class="container">
                <br><br>
                <h1 class="display-3">Laporan Gaji Karyawan</h1>
            </div>
        </div>
        ...
        <div class="form-inline d-flex justify-content-center md-form form-sm mt-0">
            ...
            <a class="btn btn-success ml-3" href="buat_laporan_gaji.php" role="button">Buat Laporan</a>
            <a class="btn btn-success ml-3" href="upload_laporan_gaji.php" role="button">Upload</a>
        </div>
        ...
        <div class="container-fluid table-responsive-xl">
            ...
            <table class="table table-hover">
                ...
                <tbody id="myTable">
                    <?php
                    $query = mysqli_query($conn, "select * from filegaji order by nfile asc");
                    if(mysqli_num_rows($query) > 0){
                        ...
                        while($row = mysqli_fetch_array($query)){
                            ...
                            <a class="btn btn-danger btn-sm" href="hapus_laporan_gaji.php?id='.$row['id'].'&file='.$row['file'].'" role="button" onclick="return confirm(\'yakin ingin menghapus file ini?\')">Hapus</a>
                            </td>';
                            $no++;
                        }
                    }
