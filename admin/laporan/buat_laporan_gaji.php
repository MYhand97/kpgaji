...
<body>
    ...
    <main role="main">
        ...
        <div class="jumbotron">
            <div class="container">
                <br><br>
                <h1 class="display-3">Laporan Gaji</h1>
            </div>
        </div>
        ...
        <div class="container">
            <div class="card card-signin">
                <div class="card-body">
                    <h5 class="card-title text-center">Buat Laporan Gaji Karyawan</h5>
                    
                    
                    

                    <br>
                    <form class="form-signin" action="buat_lapgaji.php" method="POST">
                        <div class="form-label-group">
                            <label for="periode">Periode</label>
                            <select class="form-control" id="periode" name="periode">
                            <?php
                            $query=mysqli_query($conn, "select periode, COUNT(*) as j from tbgaji GROUP BY periode HAVING j>=1 ORDER BY j asc");
                        ...
                        <hr>
                        <button class="btn btn-success btn-block" type="submit" name="submit">Buat Laporan</button>
                        <a class="btn btn-danger btn-block" href="laporan_gaji.php" role="button"> Kembali </a>
