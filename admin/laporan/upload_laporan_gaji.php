            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="../laporan/laporan_gaji.php">Laporan Gaji Karyawan</a>
                    </div>
                </li>
            </ul>
        ...
        <div class="container">
            <div class="card card-signin">
                <div class="card-body">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        if(in_array($file_ext, $allowed_ext) === true){
                            if($file_size < 10485760){
                                $lokasi = 'filesgaji/'.$nama.'.'.$file_ext;
                                move_uploaded_file($file_tmp, $lokasi);
                                $query = mysqli_query($conn, "insert into filegaji(id,tglupload,nfile,tipefile,ukfile,file)
                                values (NULL, '$tgl', '$nama', '$file_ext', '$file_size','$lokasi')") or die(mysqli_error($conn));
                                if($query){
                                    echo '<script>alert("Berhasil mengupload file."); document.location="laporan_gaji.php";</script>';
                                }
                                else{
                    ...
                    <br>
                    <form class="form-signin" action="upload_laporan_gaji.php" method="POST" enctype="multipart/form-data">
