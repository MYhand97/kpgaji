...
<body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">    
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="">Data Jabatan</a>
                </li>
                <li class="nav-item">
    ...
    <main role="main">
        ...
        <div class="form-inline d-flex justify-content-center md-form form-sm mt-0">
            ...
            <a class="btn btn-success ml-3" href="data_jabatan/tambah_jabatan.php" role="button">Tambah Data</a>
        </div>
        ...
        <div class="container-fluid table-responsive-xl">
            ...
            <table class="table table-hover">
                ...
                <tbody id="myTable">
                    <?php
                    $no = 1;
                    $query = mysqli_query($conn, "select * from jabatan order by jbtan asc");
                    while($row = mysqli_fetch_array($query)){
                        echo '<tr>';
                        echo '<th scope="row">'.$no.'</th>';
                        echo '<td>'.$row['jbtan'].'</td>';
                        echo '<td>'.$row['bagian'].'</td>';
                        echo '<td>
                        <a class="btn btn-warning btn-sm" href="data_jabatan/edit_jabatan.php?id='.$row['id'].'" role="button">Ubah</a>
                        <a class="btn btn-danger btn-sm" href="data_jabatan/hapus_jabatan.php?id='.$row['id'].'" role="button" onclick="return confirm(\'yakin ingin menghapus data ini?\')">Hapus</a>
                        </td>';
                        $no++;
                    }
                    ?>
